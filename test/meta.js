...
test('machines', function (store, t) {
  store.machines(function (err, machines) {
    ...
    t.ok(machines.indexOf('http://127.0.0.1:2379') > -1 || machines.indexOf('http://localhost:2379') > -1 || machines.indexOf(process.env.ETCD_HOST) > -1, 'found the expected ETCD_HOST')
    t.end()
  })
})
